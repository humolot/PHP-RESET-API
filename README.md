...
- "openApiBase": OpenAPI info (`{"info":{"title":"PHP-RESET-API","version":"1.0.0"}}`)
...
All configuration options are also available as environment variables. Write the config option with capitals, a "PHP_RESET_API_" prefix and underscores for word breakes, so for instance:

- PHP_RESET_API_DRIVER=mysql
- PHP_RESET_API_ADDRESS=localhost
- PHP_RESET_API_PORT=3306
- PHP_RESET_API_DATABASE=PHP-RESET-API
- PHP_RESET_API_USERNAME=PHP-RESET-API
- PHP_RESET_API_PASSWORD=PHP-RESET-API
- PHP_RESET_API_DEBUG=1

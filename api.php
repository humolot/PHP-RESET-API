...
/**
 * PHP-RESET-API v2           License: MIT
 * Gianck Luiz: madcowbr@gmail.com
 * https://github.com/humolot/php-rest-api
 *
 * Dependencies:
 * - vendor/psr/*: PHP-FIG
    ...
    class GenericDB
    {
        ...
        private function getDsn(): string
        {
            switch ($this->driver) {
                ...
                case 'sqlsrv':
                    return "$this->driver:Server=$this->address;Database=$this->database";
                case 'sqlite':
    ...
    class Config
    {
        ...
        private function applyEnvironmentVariables(array $values): array
        {
            ...
            foreach ($values as $key => $value) {
                $environmentKey = 'PHP_RESET_API_' . strtoupper(preg_replace('/(?<!^)[A-Z]/', '_$0', str_replace('.', '_', $key)));
...
namespace Tqdev\PhpCrudApi {
    ...
    $config = new Config([
        'driver' => 'mysql', // Change 
        'address' => 'localhost', // Change 
        'port' => '3306', // Change 
        'username' => 'root', // Change 
        'password' => '', // Change 
        'database' => 'database', // Change 
        'cacheType' => 'TempFile', // Change 
        'cachePath' => './cache', // Change 
        'debug' => true // Change 
    ]);
